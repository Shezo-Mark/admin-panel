                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="basic-form">
                                <form>
                                  <h4 class="card-title" style="d-block">Service Content</h4>
                                        ...
                                        <div class="form-group col-md-6">
                                         ...
                                         <div id="columns-container">
                                              <div class="columns-container">
                                                <h4 class="card-title" style="d-block">Service 1</h4>
                                                    <div class="form-row" >
                                                        <div class="col-md-6">
                                                        ...
                                                        <div class="custom-file">
                                                            ...
                                                            <label class="custom-file-label py-0 mb-0 d-flex align-items-center">
                                                                Service Image 
...
<script>
    ...
    addButton.addEventListener('click', function () {
        ...
        newDiv.innerHTML = `
                     <div class="columns-container">
                        <h4 class="card-title" style="d-block">Service 2</h4>
                            <div class="form-row" >
                                <div class="col-md-6">
                                <label>Service Image</label>
                                <div class="custom-file">
